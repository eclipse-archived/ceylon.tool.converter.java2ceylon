...
public class DoWhileTest {
	...
	public void testConstructors() throws IOException {
		Main.main(new String[] { testFile + "TestDoWhile.java", convertedFile });
		File file2 = new File(ceylonFile + "testDoWhile.ceylon");
		assertTrue("Do while test failed", FileUtils.contentEquals(file1, file2));
	}
}
