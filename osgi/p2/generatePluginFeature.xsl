...
<feature
      id="{$featureId}"
      label="Java To Ceylon Converter Feature"
      version="{$featureVersion}"
      provider-name="Red Hat">
   <description>
      The Java To Ceylon Converter Feature provides all the OSGI bundles required to use the Java To Ceylon converter inside Eclipse.
   </description>
