...
<feature
      id="{$featureId}"
      label="Java To Ceylon Converter Binary Dependencies Feature"
      version="{$featureVersion}"
      provider-name="Red Hat">
   <description>
      The Java To Ceylon Converter Binary Dependencies Feature provides only the fixed binary dependencies of the Java To Ceylon Converter.
      This is only needed to compile the Ceylon IDE plugin by using the bundle proxy projects.
   </description>
